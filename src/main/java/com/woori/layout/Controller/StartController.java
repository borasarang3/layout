package com.woori.layout.Controller;
...
public class StartController {
    ...
    public String gameProc(Integer game, String name, Model model) {
        //난수 : 컴퓨터가 임의의 수를 발생(0~0.99999999999999)사이의 수에서
        ...
        } else if (game == 2) { //사용자가 바위
            if (computer == 1) { //컴퓨터가 가위
                win = name+"가 이겼습니다.";
            }

        } else if (game == 3) { //사용자가 보
            if (computer == 2) { //컴퓨터가 바위
                win = name+"가 이겼습니다.";
            }
        }
